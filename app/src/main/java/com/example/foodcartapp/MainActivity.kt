...
fun FoodApp() {
    ...
    NavHost(
        ...
        composable("kfc") { Kfc(navController) }
        composable("kfcbucket") { Kfcbucket(navController) }
        composable("kfcfrench") { Kfcfrench(navController) }
        composable("kfcdouble") { Kfcdouble(navController) }
        composable("dominos") { Dominos(navController) }
        composable("dominospizza") { Dominospizza(navController) }
        composable("dominosgarlic") { Dominosgarlic(navController) }
