...
fun Dominos(navController: NavController) {
    Column(
        ...
        Column(modifier=Modifier.fillMaxWidth()){
            Image(painter = painterResource(id = R.drawable.dominosgarlic),
                contentDescription = null,
                contentScale = ContentScale.Crop,
                modifier = Modifier
                    .fillMaxWidth()
            ...
            Column(modifier= Modifier.padding(16.dp)) {
                Text(
                    text = "GARLIC BREAD", style = MaterialTheme.typography.headlineSmall,
                    modifier = Modifier.padding(bottom = 4.dp)
                )
                Button(onClick = { navController.navigate("dominosgarlic") },
                    modifier = Modifier) {
                    Text("View Details")
                }
            }
...
@Composable
fun Dominosgarlic(navController: NavController) {
    Column(
        modifier = Modifier.fillMaxSize(),
        horizontalAlignment = Alignment.CenterHorizontally,
        verticalArrangement = Arrangement.Center
        ...
        Column(modifier = Modifier.fillMaxWidth()) {
            Image(
                painter = painterResource(id = R.drawable.dominosgarlic),
                contentDescription = null,
                contentScale = ContentScale.Crop,
                modifier = Modifier
                    .fillMaxWidth()
            ...
            Column(modifier = Modifier.padding(16.dp)) {
                Text(
                    text = "GARLIC BREAD", style = MaterialTheme.typography.headlineLarge,
                    modifier = Modifier.padding(bottom = 4.dp)
                )
                Text(
